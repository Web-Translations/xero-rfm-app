    ...
    <div class="p-6">
        <div class="bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-200 dark:border-gray-700">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">RFM Segment Analysis</h3>
            </div>
            ...
            <div class="p-6">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 mb-6">
                    <nav class="-mb-px flex gap-6 overflow-x-auto">
                        ...
                        <button class="tab-button active py-2 px-1 border-b-2 border-blue-500 font-medium text-sm text-blue-600 dark:text-blue-400">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-6 {{ (isset($hasRfm) && !$hasRfm) ? 'opacity-50 pointer-events-none' : '' }}">
            <!-- Champions -->
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 {{ (isset($hasRfm) && !$hasRfm) ? 'opacity-50 pointer-events-none' : '' }}">
            <!-- Pie Chart -->
            <div class="bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <!-- Segment Details -->
        <div class="bg-white dark:bg-gray-900 shadow rounded-lg border border-gray-200 dark:border-gray-700 {{ (isset($hasRfm) && !$hasRfm) ? 'opacity-50 pointer-events-none' : '' }}">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
